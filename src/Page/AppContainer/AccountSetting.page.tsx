...
const AccountSetting: React.FC<Props> = (
  ...
  return (
    <div className="bg-gray-300 w-screen">
      <div
        className={
          " bg-gray-300 px-3 w-full lg:px-10" +
          (sidebarOpen
          ...
          <div className="flex flex-col md:flex-col lg:flex-row lg:mx-16 text-gray-500 gap-4">
            <div className=" mb-7">
              <img
                ...
                className=" w-36 h-36"
              ></img>
              <span className="text-blue-700 font-semibold text-sm mt-10">
                Upload picture
              </span>
            </div>
            <div className="flex flex-col lg:mx-10">
              <div className=" flex flex-col md:flex-row lg:flex-row mb-10 gap-4">
                <div className=" flex flex-col">
                  ...
                  <input
                    placeholder="Name "
                    className="border border-gray-300 shadow-inner px-2 py-2 lg:w-80 rounded-lg"
                  ></input>{" "}
                </div>
              ...
              <div className=" flex flex-col">
                <label className="mb-5">
                  ...
                  <input
                    ...
                    className="border border-gray-300 shadow-inner px-2 py-2 w-full rounded-lg"
                  ></input>
                </label>
              </div>
            </div>
